...
typedef SWIFT_ENUM(NSInteger, SVPinViewBackButtonAction, closed) {
/// Deletes the contents of the current field and moves the cursor to the previous field.
  SVPinViewBackButtonActionDeleteCurrentAndMoveToPrevious = 0,
